...
public class MainActivityPhieuDaDuyet extends MainActivityPhieuMuon {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main_phieu_da_duyet);
        ...
        lvPM.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(MainActivityPhieuDaDuyet.this);
                ...
                builder.setPositiveButton("Có", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        if (p.getTrangThai() == 0){
                            Toast.makeText(MainActivityPhieuDaDuyet.this, "Không thể xóa do phiếu mượn chưa được duyệt", Toast.LENGTH_SHORT).show();
                        }else {
                            mData.child("phieuMuon").child(p.getId()).removeValue(new DatabaseReference.CompletionListener() {
                                ...
                                public void onComplete(@Nullable DatabaseError error, @NonNull DatabaseReference ref) {
                                    if (error == null){
                                        LoadData();
                                        Toast.makeText(MainActivityPhieuDaDuyet.this, "Xóa thành công", Toast.LENGTH_SHORT).show();
                                    }
                                }
                            });
                        }
    ...
    private void showDialogDuyet(phieuMuon pm) {
        Dialog dialog = new Dialog(MainActivityPhieuDaDuyet.this);
        ...
        btnDuyet.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (pm.getTrangThai() == 0){
                    ...
                    LoadData();
                    setDuyet(btnDuyet, btnHuyDuyet);
                    Toast.makeText(MainActivityPhieuDaDuyet.this, "Duyệt thành công", Toast.LENGTH_SHORT).show();
                }
            }
        });
                ...
                mData.child("phieuMuon").child(pm.getId()).updateChildren(map, new DatabaseReference.CompletionListener() {
                    ...
                    public void onComplete(@Nullable DatabaseError error, @NonNull DatabaseReference ref) {
                        if (error == null){
                            ...
                            Toast.makeText(MainActivityPhieuDaDuyet.this, "Hủy duyệt thành công", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
            }
